...
const AddNewBusinessProfile = ({refresh}) => {
    ...
    const [businessAddress, setBusinessAddress] = useState({building: '', street: '', city: '', state: '', country: '', pincode: ''})
    const history = useHistory()

    const submitHandler = (e) => {
        e.preventDefault()
        businessProfilesService.create({companyName, legalName, email, website, taxIdentifier, businessAddress, products}).then(() => { 
            refresh();
...
export default AddNewBusinessProfile;